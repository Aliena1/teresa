...
import 'package:teresa/repository/home_active_job_repository/home_active_job_repository.dart';
class HomeActiveJobController extends GetxController{
  ...
  HomeActiveJobRepository homeActiveJobRepository=HomeActiveJobRepository();
  ...
  Future<void> _fetchPage(int pageKey) async {
    try {
      ...
      await homeActiveJobRepository.getActiveJob(queryParameters).then((value) {
