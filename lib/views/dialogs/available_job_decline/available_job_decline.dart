      ...
      return Dialog(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Padding(
                padding: EdgeInsets.only(left: Dimensions.width36,right: Dimensions.width36),
                child: Column(
                  children:[
                    SizedBox(height: Dimensions.height44,),
                    Image.asset("assets/close.png",),
                    SizedBox(height: Dimensions.height50,),
                    Text("Are you sure you want to decline the job?",style: TextStyle(
                        fontSize: Dimensions.height20,
                        fontWeight: FontWeight.bold,
                        color: Color(AppColors.VIVID_RED)
                    ),),
                    SizedBox(height: Dimensions.height13),
                    Text("Job once declined will still be available in the available jobs till it is accepted by another jobseeker.",style: TextStyle(
